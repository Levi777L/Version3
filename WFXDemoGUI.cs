...
public class WFXDemoGUI : MonoBehaviour
{
    ...
    private void ChangeColor()
    {
        ...
        var test = currentInstance.transform.parent.gameObject.GetComponent<Renderer>();
        if (test.material.HasProperty("_EmissionColor"))
        {
            SetMatHUEColor(test.material, "_EmissionColor", colorHUE);
        }
